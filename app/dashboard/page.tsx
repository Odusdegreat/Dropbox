...
export default function DashboardPage() {
  ...
  // Hidden input refs (for browse + add image)
  const [browseInput, setBrowseInput] = useState<HTMLInputElement | null>(null);
  const [addImageInput, setAddImageInput] = useState<HTMLInputElement | null>(
    null
  );
  ...
  // -------- Uploads --------
  const handleFiles = (files: FileList | null, targetPath?: string) => {
